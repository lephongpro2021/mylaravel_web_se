						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								<div class="media beta-sales-item">
									<a class="pull-left" href="chi-tiet-san-pham/18"><img src="source/image/product/hamburger.jpg" alt=""></a>
									<div class="media-body">
										Hamburger 
										<span class="beta-sales-price">20000</span>
									</div>
								</div>
								<div class="media beta-sales-item">
									<a class="pull-left" href="chi-tiet-san-pham/12"><img src="source/image/product/cafe-sua.jpg" alt=""></a>
									<div class="media-body">
										Cà phê sữa
										<span class="beta-sales-price">12000</span>
									</div>
								</div>
								<div class="media beta-sales-item">
									<a class="pull-left" href="chi-tiet-san-pham/22"><img src="source/image/product/banh-mi.jpg" alt=""></a>
									<div class="media-body">
										Bánh mì chả
										<span class="beta-sales-price">15000</span>
									</div>
								</div>
								<div class="media beta-sales-item">
									<a class="pull-left" href="chi-tiet-san-pham/59"><img src="source/image/product/pizza.jpg" alt=""></a>
									<div class="media-body">
										Pizza
										<span class="beta-sales-price">30000</span>
									</div>
								</div>
							</div>
						</div>
